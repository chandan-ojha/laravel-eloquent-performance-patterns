<!DOCTYPE html>
<html class="antialiased font-sans">
<head>
...
<div class="max-w-7xl mx-auto">
    <div class="text-center">
        <div class="mt-12 w-16 h-16 mx-auto rounded-full flex justify-center items-center" style="background: #ff2d20;">
            <svg class="w-7 h-7 text-white fill-current" viewBox="0 0 140 140">
        ...
        <h2 class="mt-4 text-3xl leading-9 tracking-tight font-extrabold text-gray-900 sm:text-4xl sm:leading-10">
            The Eloquent Blog
        </h2>
        <p class="mt-3 max-w-lg mx-auto text-xl leading-7 text-gray-500 sm:mt-4">
